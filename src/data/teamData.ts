...
export const teamMembers: TeamMember[] = [
    {
        ...
        accentColor: '#3b82f6',
        bio: 'Former lecturer at University of Lagos with 12 years of experience. Amara specialises in transforming complex mathematical concepts into clear, digestible lessons for students at every level.',
        fullBio: `Amara Okafor is a distinguished mathematics educator with over a decade of academic and professional excellence. After completing her postgraduate studies at the University of Lagos, she joined the Faculty of Science as a lecturer, where she taught undergraduate calculus and linear algebra for seven years.

In 2018, driven by a passion for personalised learning, Amara transitioned to private tutoring and quickly became one of Fastlane's most sought-after instructors. Her signature "Visual Mathematics" method breaks down abstract concepts into intuitive diagrams and real-world applications that resonate with students across all learning styles.

Amara holds an MSc in Applied Mathematics and has co-authored a mathematics workbook used by over 2,000 WAEC candidates across Nigeria and Ghana. Outside the classroom, she mentors young female students in STEM through the "She Counts" initiative.`,
        image: AboutImg,
        ...
        certifications: [
            {
                ...
                issuer: 'Mathematical Association of Nigeria',
                year: '2015',
            },
            {
                title: 'Cambridge International Examiner',
        ...
        socials: [
            { platform: 'linkedin', handle: 'amara-okafor-edu', url: 'https://linkedin.com/in/amara-okafor-edu' },
            { platform: 'twitter', handle: '@AmaraMaths', url: 'https://twitter.com/AmaraMaths' },
            { platform: 'email', handle: 'amara@fastlane.ng', url: 'mailto:amara@fastlane.ng' },
        ],
    },
    {
        id: 'james-whitfield',
...
Beyond academics, James is a published poet and literary critic, contributing regularly to The Lagos Review of Books. He runs weekend creative writing workshops for Fastlane students, believing that authentic expression and examination success are not mutually exclusive.`,
        image: HeroImg,
        tag: 'British & American Curriculum',
        yearsExperience: 10,
        studentsHelped: 340,
        passRate: '98%',
        specialisms: ['IGCSE English', 'A-Level Literature', 'SAT Reading & Writing', 'Critical Essay Technique', 'Creative Writing'],
        subjects: ['English Language', 'English Literature', 'General Paper', 'SAT Verbal'],
        quote: 'Precision in language is precision in thought. Master one, and the other follows.',
        education: [
            {
                degree: 'BA English Language & Literature (First Class)',
                institution: 'University of Oxford',
                year: '2013',
            },
            {
                degree: 'PGCE Secondary English',
        ...
        certifications: [
            {
                ...
                issuer: 'Department for Education, UK',
                year: '2014',
            },
            {
                title: 'TESOL Certificate (Advanced)',
        ...
        socials: [
            { platform: 'linkedin', handle: 'james-whitfield-english', url: 'https://linkedin.com/in/james-whitfield-english' },
            { platform: 'twitter', handle: '@JWhitfieldEdu', url: 'https://twitter.com/JWhitfieldEdu' },
            { platform: 'instagram', handle: '@james.writes', url: 'https://instagram.com/james.writes' },
            { platform: 'email', handle: 'james@fastlane.ng', url: 'mailto:james@fastlane.ng' },
        ],
    },
    {
        id: 'fatima-al-hassan',
...
Dr. Al-Hassan is the author of "Biology Unpacked," a revision guide widely circulated among IGCSE and A-Level students across Anglophone West Africa. She regularly volunteers as a guest lecturer at government secondary schools through the Fastlane Gives Back programme.`,
        image: AboutImg,
        tag: 'Nigerian & American Curriculum',
        yearsExperience: 14,
        studentsHelped: 510,
        passRate: '99%',
        specialisms: ['Biology', 'Chemistry', 'Biochemistry', 'Exam Technique', 'University Application Science', 'WAEC Science'],
        subjects: ['Biology', 'Chemistry', 'Human Biology', 'Biochemistry'],
        quote: 'Science is not a collection of facts to memorise. It is a way of asking better questions.',
        education: [
            {
            ...
            {
                degree: 'BSc Biochemistry (First Class)',
                institution: 'University of Ibadan',
                year: '2005',
            },
        ],
        certifications: [
            ...
            {
                title: 'Fellow, Science Education Board of Nigeria',
                issuer: 'Federal Ministry of Education',
                year: '2020',
            },
        ],
        socials: [
            { platform: 'linkedin', handle: 'dr-fatima-al-hassan', url: 'https://linkedin.com/in/dr-fatima-al-hassan' },
            { platform: 'twitter', handle: '@DrFatimaScience', url: 'https://twitter.com/DrFatimaScience' },
            { platform: 'email', handle: 'fatima@fastlane.ng', url: 'mailto:fatima@fastlane.ng' },
        ],
    },
    {
        id: 'david-mensah',
        name: 'David Mensah',
        role: 'History & Humanities',
...
At Fastlane, David's classes are legendary for their storytelling. By making history vivid, personal, and directly relevant to examination essays, he has transformed students who "hated history" into some of the subject's most enthusiastic practitioners. His source-analysis technique, taught in his popular "READ the Source" workshop, has become standard preparation for IGCSE and A-Level History across the school.`,
        image: HeroImg,
        tag: 'British Curriculum',
        yearsExperience: 11,
        studentsHelped: 280,
        passRate: '97%',
        ...
        education: [
            ...
            {
                degree: 'MA International History',
                institution: 'University of Edinburgh',
                year: '2010',
            },
            {
                degree: 'BA History & Political Science',
        ...
        socials: [
            { platform: 'linkedin', handle: 'david-mensah-history', url: 'https://linkedin.com/in/david-mensah-history' },
            { platform: 'twitter', handle: '@DavidMensahPhD', url: 'https://twitter.com/DavidMensahPhD' },
            { platform: 'instagram', handle: '@mensah.teaches', url: 'https://instagram.com/mensah.teaches' },
            { platform: 'email', handle: 'david@fastlane.ng', url: 'mailto:david@fastlane.ng' },
        ],
    },
    {
        id: 'chisom-eze',
...
Chisom holds a BSc in Computer Science and two industry-recognised certifications. He also runs "Code Club," a free weekly session for underprivileged students in Lagos, teaching the fundamentals of programming and digital literacy. In 2023, two of his Code Club students were accepted onto Google's STEP intern programme.`,
        ...
        studentsHelped: 390,
        passRate: '98%',
        specialisms: ['IGCSE Computer Science', 'A-Level Computer Science', 'Python Programming', 'Web Development', 'Data Science Fundamentals', 'WAEC ICT'],
        subjects: ['Computer Science', 'ICT', 'Programming', 'Digital Technology'],
        quote: 'Code is the most powerful literacy of our generation. Every student deserves to speak it fluently.',
        education: [
            {
                degree: 'BSc Computer Science (Second Class Upper)',
        ...
        certifications: [
            ...
            {
                title: 'Cambridge IGCSE CS Examiner',
                issuer: 'Cambridge Assessment International Education',
                year: '2022',
            },
        ],
        socials: [
            { platform: 'linkedin', handle: 'chisom-eze-tech', url: 'https://linkedin.com/in/chisom-eze-tech' },
            { platform: 'twitter', handle: '@ChisomBuilds', url: 'https://twitter.com/ChisomBuilds' },
            { platform: 'instagram', handle: '@chisom.codes', url: 'https://instagram.com/chisom.codes' },
            { platform: 'email', handle: 'chisom@fastlane.ng', url: 'mailto:chisom@fastlane.ng' },
        ],
    },
    {
        id: 'rachel-adeyemi',
        name: 'Rachel Adeyemi',
        role: 'Languages & Literature',
...
Rachel is also a published short-story author in both English and French, and she integrates creative literature into every course she teaches. Her curated reading lists have become a beloved extension of the curriculum for hundreds of Fastlane students.`,
        ...
        education: [
            {
                ...
                institution: 'Institut National des Langues, Paris (INALCO)',
                year: '2016',
            },
            {
                degree: 'BA Languages & Linguistics',
                institution: 'University of Ibadan',
                year: '2014',
            },
        ],
        certifications: [
            ...
            {
                title: 'Alliance Française Certified Instructor',
                issuer: 'Alliance Française de Lagos',
                year: '2017',
            },
        ],
        socials: [
            { platform: 'linkedin', handle: 'rachel-adeyemi-languages', url: 'https://linkedin.com/in/rachel-adeyemi-languages' },
            { platform: 'instagram', handle: '@rachel.lingua', url: 'https://instagram.com/rachel.lingua' },
            { platform: 'email', handle: 'rachel@fastlane.ng', url: 'mailto:rachel@fastlane.ng' },
        ],
    },
];
